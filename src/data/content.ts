...
export const selectedWork = [
  { id: "lancesoft-outbound-gtm", title: "Outbound GTM & RevOps at LanceSoft", category: "Growth Marketing", summary: "Built outbound demand-generation programs across staffing and HR technology using account targeting, enrichment, cold email and multi-touch engagement. Architected AI-powered RevOps workflows using Clay, Make, AI agents and HubSpot.", tags: ["Outbound", "RevOps", "AI Automation", "Clay", "HubSpot"] },
  { id: "wisestep-pamgro-gtm", title: "PamGro GTM Build at Wisestep", category: "GTM Strategy", summary: "Founded GTM strategy for PamGro's EOR offering. Built outbound motion targeting 11-500 employee companies. Generated 10 qualified meetings, contributed to 2 closed customers and 1 enterprise opportunity worth $30K-$50K ARR.", tags: ["GTM", "Outbound", "B2B SaaS", "Sales Enablement"] },
  { id: "ai-revops-automation", title: "AI-Powered RevOps Automation", category: "Marketing Automation", summary: "Built AI-driven workflows using Clay, N8N, Make and Zapier for outbound sequencing, lead enrichment and pipeline operations. Reduced operational overhead by 5 hours per week.", tags: ["AI", "Automation", "RevOps", "Clay", "N8N"] },
  { id: "sportskeeda-partner-growth", title: "Partner Growth at Sportskeeda", category: "Growth", summary: "Built publisher and creator growth programs with co-marketing and revenue-share partnerships. Achieved 21% increase in traffic and revenue, 30% improvement in partner conversion efficiency.", tags: ["Growth", "Partnerships", "Affiliate", "Lifecycle"] },
];
